...
% Last Modified by GUIDE v2.5 26-Apr-2016 16:16:56
...
function local_iterations_Callback(hObject, eventdata, handles)
% hObject    handle to local_iterations (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of local_iterations as text
%        str2double(get(hObject,'String')) returns contents of local_iterations as a double
s = str2double(get(hObject,'String'));
if isnan(s)
...
% --- Executes during object creation, after setting all properties.
function local_iterations_CreateFcn(hObject, eventdata, handles)
% hObject    handle to local_iterations (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
if selection ~= 1
    ...
    set(handles.local_iterations, 'Enable', 'Off')
    ...
    simulatedannealing(cities,...
        ...
        str2double(get(handles.local_iterations,'String')),...
    ...
    set(handles.local_iterations, 'Enable', 'On')
