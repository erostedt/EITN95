...
public class SignalList{
	...
	public static void SendSignal(int type, Proc dest, double arrtime, int destination_x,int destination_y){
 	Signal dummy, predummy;
 	Signal newSignal = new Signal();
 	newSignal.signalType = type;
 	newSignal.destination = dest;
	newSignal.arrivalTime = arrtime;
	newSignal.destination_x = destination_x;
	newSignal.destination_y = destination_y;
 	predummy = list;
 	dummy = list.next;
